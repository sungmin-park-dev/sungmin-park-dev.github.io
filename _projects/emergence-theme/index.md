...
description: "Open-source Jekyll design system with Deep Glacier light and Stellar Field dark environments, reusable presets, and tokenized components"
categories: [Projects]
icon: fas fa-palette
...
image-led Deep Glacier / Stellar Field preset already applied.

## Features

- Deep Glacier light and Stellar Field dark environments with a persistent runtime toggle
...
- Deep Glacier and Stellar Field share one information structure while retaining independent optical treatment
...
- [Deep Glacier / Stellar Field Preset](https://github.com/emergence-project/emergence-theme/tree/main/presets/glacier-stellar)
